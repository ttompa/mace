...
def run(args) -> None:
    ...
    # Cueq and OEQ conversion - MUST happen BEFORE LoRA injection
    # so that LoRA can properly wrap cuet.Linear layers
    ...
    # LoRA injection - after cueq/oeq conversion so we wrap the correct layer types
    if args.lora:
